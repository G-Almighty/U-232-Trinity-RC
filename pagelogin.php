...
$hash1.= $hash2 . $hash3;
$res = sql_query("SELECT id, username, hash2, enabled FROM users WHERE hash1 = " . sqlesc($hash1) . " AND class >= " . UC_STAFF . " AND status = 'confirmed' LIMIT 1") or sqlerr(__FILE__, __LINE__);
